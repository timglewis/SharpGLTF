...
namespace SharpGLTF.Schema2
{
    ...
    public partial class StructuralMetadataClass
    {
        ...
        public StructuralMetadataClass WithInt32(string name, string description, int defaultValue) => WithComponentProperty(ElementType.SCALAR, ComponentType.UINT32, name, description, defaultValue.ToString());
        public StructuralMetadataClass WithUInt32(string name, string description) => WithComponentProperty(ElementType.SCALAR, ComponentType.INT32, name, description);
        public StructuralMetadataClass WithUInt32(string name, string description, int defaultValue) => WithComponentProperty(ElementType.SCALAR, ComponentType.UINT32, name, description, defaultValue.ToString());
        public StructuralMetadataClass WithInt64(string name, string description) => WithComponentProperty(ElementType.SCALAR, ComponentType.INT64, name, description);
        public StructuralMetadataClass WithInt64(string name, string description, uint defaultValue) => WithComponentProperty(ElementType.SCALAR, ComponentType.INT64, name, description, defaultValue.ToString());
        public StructuralMetadataClass WithUInt64(string name, string description) => WithComponentProperty(ElementType.SCALAR, ComponentType.UINT64, name, description);
        public StructuralMetadataClass WithUInt64(string name, string description, uint defaultValue) => WithComponentProperty(ElementType.SCALAR, ComponentType.UINT64, name, description, defaultValue.ToString());
        public StructuralMetadataClass WithSingle(string name, string description) => WithComponentProperty(ElementType.SCALAR, ComponentType.FLOAT32, name, description);
        public StructuralMetadataClass WithSingle(string name, string description, uint defaultValue) => WithComponentProperty(ElementType.SCALAR, ComponentType.FLOAT32, name, description, defaultValue.ToString());
        public StructuralMetadataClass WithDouble(string name, string description) => WithComponentProperty(ElementType.SCALAR, ComponentType.FLOAT64, name, description);
        public StructuralMetadataClass WithDouble(string name, string description, uint defaultValue) => WithComponentProperty(ElementType.SCALAR, ComponentType.FLOAT64, name, description, defaultValue.ToString());
