...
namespace SharpGLTF.Schema2
{
	...
	/// </summary>
	partial class StructuralMetadataPropertyAttributeProperty : ExtraProperties
	{
	...
	/// </summary>
	partial class StructuralMetadataPropertyAttribute : ExtraProperties
	{
		...
		private Dictionary<String,StructuralMetadataPropertyAttributeProperty> _properties;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				...
				case "properties": DeserializePropertyDictionary<StructuralMetadataPropertyAttributeProperty>(ref reader, _properties); break;
				default: base.DeserializeProperty(jsonPropertyName,ref reader); break;
			}
		}
