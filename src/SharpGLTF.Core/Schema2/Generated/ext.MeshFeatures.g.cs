...
namespace SharpGLTF.Schema2
{
	...
	/// </summary>
	partial class MeshFeatureFeatureIdTexture : TextureInfo
	{
	...
	/// </summary>
	partial class MeshFeatureFeatureId : ExtraProperties
	{
		...
		private MeshFeatureFeatureIdTexture _texture;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				...
				case "texture": _texture = DeserializePropertyValue<MeshFeatureFeatureIdTexture>(ref reader); break;
				default: base.DeserializeProperty(jsonPropertyName,ref reader); break;
			}
		}
	...
	/// </summary>
	partial class MeshFeatures : ExtraProperties
	{
	
		private const int _featureIdsMinItems = 1;
		private List<MeshFeatureFeatureId> _featureIds;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				case "featureIds": DeserializePropertyList<MeshFeatureFeatureId>(ref reader, _featureIds); break;
				default: base.DeserializeProperty(jsonPropertyName,ref reader); break;
			}
		}
