...
namespace SharpGLTF
{
    class StructuralMetadataExtension : SchemaProcessor
    {
        ...
        private static string PropertyAttributeSchemaUri => Constants.VendorExtensionPath("EXT_structural_metadata", "propertyAttribute.schema.json");
        ...
        public override IEnumerable<(string, SchemaType.Context)> Process()
        {
            ...
            yield return ("ext.StructuralMetadataPropertyAttribute.g", ProcessPropertyAttribute());
        }
        ...
        private static SchemaType.Context ProcessPropertyAttribute()
        {
            var ctx = SchemaProcessing.LoadSchemaContext(PropertyAttributeSchemaUri);
            ctx.IgnoredByCodeEmitter("glTF Property");
            ctx.IgnoredByCodeEmitter("glTF Child of Root Property");
            ctx.IgnoredByCodeEmitter("Texture Info");
        ...
        public override void PrepareTypes(CodeGen.CSharpEmitter newEmitter, SchemaType.Context ctx)
        {
            ...
            newEmitter.SetRuntimeName("Property Attribute in EXT_structural_metadata", "StructuralMetadataPropertyAttribute");
            newEmitter.SetRuntimeName("Property Attribute Property in EXT_structural_metadata", "StructuralMetadataPropertyAttributeProperty");
